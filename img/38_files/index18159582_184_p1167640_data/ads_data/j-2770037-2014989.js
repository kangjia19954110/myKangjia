...
(function(){
    ...
    (function() {
    var p = "2770037", n = JSON.parse('[]'), w = window, f = function(s) {
...
o.is = function platform(navigator) {
    ...
    var data = {
    params:window.ftParams_2770037||'',
    GUID:window.ftGUID_2770037||'99999999999',
    confID:window.ftConfID_2770037||'0',
    ftReturn: window.ftReturn_2770037||'',
    keyword:window.ftKeyword_2770037||'',
    ftId:window.ftId_2770037||'',
    imp:window.ftImp2770037,
    ftImpId:window.ftImp2770037 && window.ftImp2770037.impID || '',
    campaignID:'83967',
    cID:'82984',
    pID:'2770037',
    creativeID:'2014989',
    exttrack:[],
    extscript:[""],
    clickTags: ["http://servedby.flashtalking.com/click/4/83967;2770037;2014989;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://dami.ksyun.com/special-product/index.html?ch=00033.00037.0001&utm_source=inter&utm_medium=display&utm_campaign=jm-traffic-gen&utm_content=creative-name&utm_term=whitelist"],
    placementDescription:'INTELAWSIntelCSPKingSoftTrafficGenCampaignFY17Q4JMMMVDWhitelistBNCH300x250',
    width:300,
    height:250,
    ...
    divID:'ftdiv2770037',
    phID:'ftpos2770037',
    frameID:'ftframe2770037',
    expID:'ftexpframe2770037',
    altImgID:'ftalt2770037',
    altText:'Click here',
    altImgTarget:'_blank',
    altimghref:'http://servedby.flashtalking.com/click/4/83967;2770037;2014989;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=300&ft_height=250&url=https://dami.ksyun.com/special-product/index.html?ch=00033.00037.0001&utm_source=inter&utm_medium=display&utm_campaign=jm-traffic-gen&utm_content=creative-name&utm_term=whitelist',
    altImg:'http://servedby.flashtalking.com/imp/4/83967;2770037;204;gif;JMProgrammaticBuyingPlatform;INTELAWSIntelCSPKingSoftTrafficGenCampaignFY17Q4JMMMVDWhitelistBNCH300x250/?',
    viewableImpressionURL:'http://servedby.flashtalking.com/imp/4/83967;2770037;271;pixel;JMProgrammaticBuyingPlatform;INTELAWSIntelCSPKingSoftTrafficGenCampaignFY17Q4JMMMVDWhitelistBNCH300x250/?',
    iDeviceImp:'http://servedby.flashtalking.com/imp/4/83967;2770037;207;guid;JMProgrammaticBuyingPlatform;INTELAWSIntelCSPKingSoftTrafficGenCampaignFY17Q4JMMMVDWhitelistBNCH300x250/?ft_guid=[%FT_GUID%]&cachebuster=[%CACHEBUSTER%]',
    stump:'http://servedby.flashtalking.com',
    jsurl:'http://cdn.flashtalking.com/xre/277/2770037/2014989/js/j-2770037-2014989.js',
    file:'http://cdn.flashtalking.com/82984/2014989/main.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM:'http://cdn.flashtalking.com',
    statBaseURL:'http://stat.flashtalking.com/reportV3/ft.stat?97566846-2770037;2014989;',
    adVis:false ? 1 : 0,
    centreAd:true,
    mvt:false,
    segment:window.ftSegment_2770037||'',
    segmentList:window.ftSegmentList_2770037||[],
    ...
    baggyFrameLimit:15,
    append:!!(window.ftImp2770037 && window.ftImp2770037.jsAppend),
    ...
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m2770037')&&/^https:/.test(document.getElementById('ftscript_m2770037').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc',''))),
    scriptLocation: document.getElementById('ftscript_m2770037'),
    ...
    qsVars:[
        ['ftguid', 'ftGUID_2770037'],
        ['ftcfid', 'ftConfID_2770037'],
        ['fttime', 'ftTimestamp_2770037'],
        ['ftsection', 'ftSection_2770037'],
        ['ftcustom', 'ftCustom_2770037'],
        ['ft_id', 'ftId_2770037'],
        ['ftimpid','ftImp2770037', 'impID']
    ]
};
