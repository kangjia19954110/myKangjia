    ...
    $.fn.Page = function(options){
        ...
        return this.each(function(){
            ...
            obj.on('click','.next',function(){
                ...
                }else if((pageshow > l - nums / 2 && pageshow < l && flag == false) || (pageshow > l - nums / 2 - 1 && pageshow < l && fla == true )){
            ...
            function fpageShow(activePage){
                ...
                for(i = 0; i< n;i++){
                    ...
                    str1 += '<li><a href="javasceipt:" class="">' +(pageStart + i)+ '</a></li>';
                }
